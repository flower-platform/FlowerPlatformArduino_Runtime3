...
public:
	...
	void readSensors(void* self, void (*callback)(void* self, int)) {
		callFunction(PSTR("readSensors"), NULL, (void*) callback, TYPE_INT, self);
	}

	void getVersion(void* self, void (*callback)(void* self, int)) {
		callFunction(PSTR("getVersion"), NULL, (void*) callback, TYPE_INT, self);
	}

	void init(const char* robotModel, void* self, void (*callback)(void* self, bool)) {
